# Generated by Django 5.1.4 on 2026-03-31 04:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='taught_courses', to=settings.AUTH_USER_MODEL, verbose_name='instructor')),
            ],
            options={
                'verbose_name': 'course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='lesson_files/', verbose_name='file')),
