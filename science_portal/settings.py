...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-fallback-key-please-change')
...
MIDDLEWARE = [
    ...
    'courses.middleware.BruteForceProtectionMiddleware',
]
...
# CORS settings (if needed in production)
